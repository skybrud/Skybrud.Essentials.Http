...
public class HttpRequestTests {
    ...
    public void SetQueryStringNull() {
        ...
        // types are mostly just suggestions, so if passed a null value, the property will set its value to a new
    ...
    public void SetPostDataNull() {
        ...
        // are mostly just suggestions, so if passed a null value, the property will set its value to a new
    ...
    public void SetAcceptHeaderCollection() {
        ...
        IHttpRequest request1 = HttpRequest
            .New()
            .SetAcceptHeader(["application/json", "text/xml"]);
    ...
    public void SetAuthorizationHeader() {
        ...
        // "WebHeaderCollection" returns an empty string if the header doesn't exist or was previously set to null.
